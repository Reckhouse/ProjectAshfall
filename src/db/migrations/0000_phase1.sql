-- Phase 1 schema: auth identity, worlds, players, bases, resources, idempotent actions.
-- Keep in sync with src/db/schema/index.ts and src/db/migrations/phase1.ts.
